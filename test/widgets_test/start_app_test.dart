...
void main() {
  ...
  ///this test case for run application
  ///open welcome screen
  ///press choose country button and open buttonSheet
  ///press on Jordan country
  ///close buttonSheet
  ///press arabic button
  ///go to WalkThrowScreen

  Client clients = Client();
  NetworkApiService.client = clients;

  testWidgets('Start the application for the first time',
      (WidgetTester tester) async {
    await tester.runAsync(() async {
      SharedPreferences.setMockInitialValues({AppRepo.themeKey: 1});
